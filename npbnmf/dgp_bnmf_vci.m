...
% Save matrices
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/bnmf_dgp_vci_out/dgp_EWA_",    num2str(j), "_001.mat"), 'EWA');
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/t0_bnmf_dgp_vci_out/t0_dgp_EH_",     num2str(j), "_001.mat"), 'EH');

save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/t0_bnmf_dgp_vci_out/t0_dgp_upperWA_",  num2str(j), "_001.mat"), 'upper_ci');
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/t0_bnmf_dgp_vci_out/t0_dgp_lowerWA_",  num2str(j), "_001.mat"), 'lower_ci');

save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/prop_out_t0/t0_save_prop",  num2str(j), "_001.mat"), 'save_prop');
