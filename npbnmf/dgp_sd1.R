...
# Read in Sims
load("/ifs/scratch/msph/ehs/eag2186/Data/sim_dgp_sd1.RDA")
...
output_all <- sim_dgp_sd1[job_num,] %>% 
...
save(output_all, file = paste0("/ifs/scratch/msph/ehs/eag2186/npbnmf/dgp_sd1/dgp_sd1_sims", job_num, ".RDA"))
