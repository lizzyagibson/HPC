...
% Import the data
simdata1 = readtable(strcat("/ifs/scratch/msph/ehs/eag2186/Data/dgp_rep1/sim_dgp_rep1_", num2str(i), ".csv"));
...
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/dgp_rep1_100/rep1_ewa_dist_", num2str(i), ".mat"), 'EWA');
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/dgp_rep1_100/rep1_eh_dist_",  num2str(i), ".mat"), 'EH');
