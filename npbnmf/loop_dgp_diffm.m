...
% Import the data
simdata1 = readtable(strcat("/ifs/scratch/msph/ehs/eag2186/Data/dgp_local/sim_dgp_local_", num2str(i), ".csv"));
...
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/dgp_100/ewa_dist_", num2str(i), ".mat"), 'EWA');
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/dgp_100/eh_dist_",  num2str(i), ".mat"), 'EH');
