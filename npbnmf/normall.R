...
# Read in Sims
load("/ifs/scratch/msph/ehs/eag2186/Data/sim_normall.RDA")
...
output_all <- sim_normall[job_num,] %>% 
...
save(output_all, file = paste0("/ifs/scratch/msph/ehs/eag2186/npbnmf/normall/normall_sims", job_num, ".RDA"))
