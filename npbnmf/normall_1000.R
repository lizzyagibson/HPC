...
# Read in Sims
load("/ifs/scratch/msph/ehs/eag2186/Data/sim_normall_1000.RDA")
...
#load("/ifs/scratch/msph/ehs/eag2186/npbnmf/dim_to_do.RDA")
#if (!(job_num %in% dim_to_do)) {stop("Job id already ran.")}
...
output_all <- sim_normall_1000[job_num,] %>% 
...
save(output_all, file = paste0("/ifs/scratch/msph/ehs/eag2186/npbnmf/normall_1000/normall_sims_1000", job_num, ".RDA"))
