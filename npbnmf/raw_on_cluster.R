...
# Read in Sims
load("/ifs/scratch/msph/ehs/eag2186/Data/sim_old.RDA")
...
save(output_all, file = paste0("/ifs/scratch/msph/ehs/eag2186/npbnmf/raw_out/raw_sims", job_num, ".RDA"))
